local M = {}
local SUPPORTED_PLUGINS = require("cynosure.plugins.supported_plugins")
...
function M.load(theme)
  local ok
  ok, theme = pcall(require, "cynosure.palettes." .. theme)
  theme = ok and theme or require("cynosure.palettes.cynosure")

  local c = vim.deepcopy(theme)
  local group_fn = require("cynosure.highlights")
  ...
  for name, setting in pairs(M.opts.plugin_support) do
    if setting == true then
      ok, module = pcall(require, "cynosure.plugins." .. name)
